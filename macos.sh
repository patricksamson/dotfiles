...
sudo scutil --set ComputerName "Patricks-MBP-2023"
sudo scutil --set HostName "Patricks-MBP-2023"
sudo scutil --set LocalHostName "Patricks-MBP-2023"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Patricks-MBP-2023"
...
# Set machine sleep to 5 minutes while charging
